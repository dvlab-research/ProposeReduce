...
class MaxIoUAssigner(BaseAssigner):
    ...
    def __init__(self,
        ...
        self.gt_pids_minus = gt_pids_minus
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None, gt_pids=None):
        ...
        if bboxes.shape[0] == 0 or gt_bboxes.shape[0] == 0:
            raise ValueError('No gt or bboxes', bboxes.shape, gt_bboxes.shape)
            # ''' no gt, make all as neg'''
    ...
    def assign_wrt_overlaps(self, overlaps, gt_labels=None, gt_pids=None):
        ...
        if gt_pids is not None:
            assigned_pids = assigned_gt_inds.new_zeros((num_bboxes,)) - self.gt_pids_minus
            pos_inds = torch.nonzero(assigned_gt_inds > 0).squeeze()
            if pos_inds.numel() > 0:
        ...
        return AssignResult(
            num_gts, assigned_gt_inds, max_overlaps, labels=assigned_labels, 
                pids=assigned_pids, overlaps=overlaps)
