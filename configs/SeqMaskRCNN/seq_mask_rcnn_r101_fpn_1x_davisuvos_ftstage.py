...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'valid_davis.json',
        img_prefix=data_root + 'trainvalset_davis',
        img_scale=(854, 480),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
...
log_level = 'INFO'
work_dir = '../work_dirs/seq_mask_rcnn_r101_fpn_1x_davis_ftstage'
load_from = 'pretrained_davis/seq_mask_rcnn_r101_davis_mainstage.pth'
resume_from = None
workflow = [('train', 1)]
